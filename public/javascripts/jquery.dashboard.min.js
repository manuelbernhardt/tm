(function(a) {
    a.fn.dashboard = function(m) {
        ...
        k.setLayout = function(n) {
            ...
            a("." + b.columnClass).sortable({connectWith:a("." + b.columnClass),opacity:b.opacity,handle:"." + b.widgetHeaderClass,over:function(o, p) {
                ...
                k.element.trigger("dashboardStateChange", {stateChange:"widgetMoved",widget:o});
                k.log("widgetDropped event thrown for widget " + o.id, 2);
                o.element.trigger("widgetDropped", {widget:o})
        ...
        k.loadLayout = function() {
            ...
            if (typeof b.json_data.url != "undefined" && b.json_data.url.length > 0) {
                ...
                a.getJSON(b.json_data.url, function(p) {
                    ...
                    var o = (typeof k.layout != "undefined") ? k.layout : c(p.layout);
                    k.setLayout(o);
                    k.loadWidgets(p.data)
                })
            } else {
        ...
        k.addWidget = function(r, p) {
            ...
            if (typeof k.widgets[q] != "undefined" && a("#" + q).length > 0) {
                ...
                var n = a(o);
                n.appendTo(p);
                k.widgets[q] = h({id:q,element:n,column:r.column,url:(typeof r.url != "undefined" ? r.url : null),editurl:r.editurl,title:r.title,open:r.open,metadata:r.metadata})
            }
            k.log("widgetAdded event thrown for widget " + q, 2);
            k.widgets[q].element.trigger("widgetAdded", {widget:k.widgets[q]});
            if (k.initialized) {
                k.log("dashboardStateChange event thrown for widget " + q, 2);
                k.element.trigger("dashboardStateChange", {stateChange:"widgetAdded",widget:n})
            }
        };
        ...
        function h(n) {
            ...
            n.openContent = function() {
                ...
                if (!n.loaded) {
                    if (this.url != "" && this.url != null && typeof this.url != "undefined") {
                        ...
                        n.element.trigger("widgetShow", {widget:n});
                        n.element.find("." + b.widgetContentClass).load(this.url, function(p, o, q) {
                            ...
                            n.element.trigger("widgetLoaded", {widget:n})
                        })
                    } else {
                        k.log("widgetShow event thrown for widget " + n.id, 2);
                        n.element.trigger("widgetShow", {widget:n});
                ...
                if (k.initialized) {
                    ...
                    k.element.trigger("dashboardStateChange", {stateChange:"widgetOpened",widget:n})
                }
            };
            ...
            n.setTitle = function(o) {
                ...
                if (k.initialized) {
                    k.log("dashboardStateChange event thrown for widget " + n.id, 2);
                    k.element.trigger("dashboardStateChange", {stateChange:"titleChanged",widget:n})
                }
            };
            n.closeContent = function() {
                ...
                n.element.trigger("widgetHide", {widget:n});
                n.element.find(".widgetOpen").show();
                n.element.find(".widgetClose").hide();
                k.log("dashboardStateChange event thrown for widget " + n.id, 2);
                k.element.trigger("dashboardStateChange", {stateChange:"widgetClosed",widget:n})
            };
            n.addMetadataValue = function(o, p) {
                ...
                n.metadata[o] = p;
                k.log("dashboardStateChange event thrown for widget " + n.id, 2);
                k.element.trigger("dashboardStateChange", {stateChange:"metadataChanged",widget:n})
            };
            n.openMenu = function() {
            ...
            n.remove = function() {
                ...
                n.element.trigger("widgetDeleted", {widget:n});
                k.log("dashboardStateChange event thrown for widget " + n.id, 2);
                k.element.trigger("dashboardStateChange", {stateChange:"widgetRemoved",widget:n})
            };
            ...
            n.openFullscreen = function() {
                ...
                n.fullscreen = true;
                var q = n.element.clone();
                var p = a('<div style="display:none" id="tempdashboard_' + k.id + '"></div>');
                p.appendTo(a("body"));
                k.element.children().appendTo(p);
            ...
            n.closeFullscreen = function() {
                ...
                a("#tempdashboard_" + k.id).children().appendTo(k.element);
                a("#tempdashboard_" + k.id).remove()
            };
            n.openSettings = function() {
                k.log("entering openSettings function", 1);
                n.element.find("." + b.widgetContentClass).load(n.editurl)
            };
            if (n.open) {
                n.openContent()
            }
            ...
            n.element.trigger("widgetInitialized", {widget:n});
            return n
        }
        ...
        a("#" + k.id + " .controls li").live("click", function(o) {
            ...
            var n = k.getWidget(a(this).closest("." + b.widgetClass).attr("id"));
            n.element.trigger(a(this).attr("class"), {widget:n});
            return false
        });
        ...
        a("#" + k.id + " ." + b.widgetTitleClass).live("click", function(o) {
            ...
            if (!a(this).hasClass("noclick")) {
                ...
                if (n.open) {
                    ...
                    n.element.trigger("widgetClose", {widget:n})
                } else {
                    k.log("widgetOpen event thrown for widget " + n, 2);
                    n.element.trigger("widgetOpen", {widget:n})
                }
            }
            return false
        });
        ...
        a("#" + l.dialogId).dialog({autoOpen:false,height:414,width:550,modal:true,buttons:{Cancel:function() {
            a(this).dialog("close")
        }},close:function() {
        }});
        ...
        a("#" + d.dialogId).dialog({autoOpen:false,height:300,width:600,modal:true});
        a("#" + k.id + " ." + d.openDialogClass).live("click", function() {
        ...
        k.element.live("dashboardStateChange", function() {
            if (typeof b.stateChangeUrl != "undefined" && b.stateChangeUrl != null && b.stateChangeUrl != "") {
                a.ajax({type:"POST",url:b.stateChangeUrl,data:{dashboard:k.element.attr("id"),settings:k.serialize()},success:function(n) {
        ...
        function i() {
            ...
            a("." + d.selectLayoutClass).bind("click", function(q) {
                ...
                if (typeof b.layoutClass != "undefined") {
                    ...
                    k.element.find("." + b.columnClass).each(function() {
        ...
        a("." + l.selectCategoryClass).live("click", function() {
            ...
            k.element.trigger("addWidgetDialogSelectCategory", {category:a(this)});
            return false
        });
        k.element.live("addWidgetDialogSelectCategory", function(o, n) {
            ...
            a.getJSON(url, {cache:true}, function(p) {
                if (p.data == 0) {
                    k.log("Empty data returned", 3)
                }
                a.each(p.data, function(r, s) {
                    k.widgetsToAdd[s.id] = s;
                    k.log("Applying template : " + l.widgetTemplate, 1);
                    if (a("#" + l.widgetTemplate).length == 0) {
                        k.log('Template "' + l.widgetTemplate + " not found", 5)
                    }
                    var q = tmpl(a("#" + l.widgetTemplate).html(), s);
                    a("#" + l.dialogId).find("." + l.widgetClass).append(q)
                })
            });
        ...
        a("." + l.addWidgetClass).live("click", function() {
            ...
            k.element.trigger("dashboardAddWidget", {widget:n});
        ...
        k.element.live("dashboardOpenWidgetDialog", function() {
            ...
            a.getJSON(l.widgetDirectoryUrl, function(n) {
                ...
                a.each(n.category, function(p, q) {
